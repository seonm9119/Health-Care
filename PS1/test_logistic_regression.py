...
def update_config(config, args):
    ...
    config.ARCH = config.LOGISTIC.ARCH
    config.freeze()
...
def main():
    ...
    checkpoint = torch.load(config.LOGISTIC.CHECKPOINT, map_location='cpu')
    ...
    with open(os.path.join(config.LOGISTIC.OUTPUT_DIR, "20214029-logistic-regression.txt"), mode="a", encoding="utf-8") as f:
        f.write('20214029')
